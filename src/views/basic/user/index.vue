...
<script lang="ts" setup>
  ...
  import { getDepartmentTree } from '@/api/basic/department';
  import useLoading from '@/hooks/loading';
  import { Department } from '@/api/basic/types/department';
  import { Message } from '@arco-design/web-vue';
  import { getRoleTree } from '@/api/basic/role';
  ...
  import { PageUserReq, User } from '@/api/basic/types/user';
  import { getUserRoles } from '@/api/basic/user-role';
